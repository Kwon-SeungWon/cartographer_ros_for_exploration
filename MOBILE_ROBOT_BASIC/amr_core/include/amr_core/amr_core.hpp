...
protected:
    ...
    // --- Parameters ---
    std::string nav_vel_parameter, enc_vel_parameter, ctr_vel_parameter, manual_vel_parameter, docking_vel_parameter;
    ...
    int32_t Main1, Main2, Sub;
    uint32_t Motor_driver;
