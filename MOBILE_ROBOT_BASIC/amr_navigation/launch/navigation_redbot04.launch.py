...
def generate_launch_description():
    ...
    map_dir = LaunchConfiguration(
        ...
        default=os.path.join(
            get_package_share_directory("amr_navigation"), "maps", "skku7th.yaml"
        ),
    )
    param_file_name = "redbot04_navigation_param.yaml"
    param_dir = LaunchConfiguration(
        "params_file",
        default=os.path.join(
            get_package_share_directory("amr_navigation"), "params", param_file_name
        ),
    )
    ...
    return LaunchDescription(
        [
            ...
            # Uncomment this block to add the "go_to_goal" node if needed
            # Node(
