...
#include "ros2_frontier_based_explore/utils.hpp"
...
namespace ros2_frontier_based_explore
{
    ...
    std::vector<Frontier> FrontierSearch::searchFrom(geometry_msgs::msg::Point position)
    {
        ...
        {
            std::cout << "Robot out of costmap bounds, cannot search for frontiers" << std::endl;
            return frontier_list;
        }
        else
            std::cout << "Search for frontiers" << std::endl;
